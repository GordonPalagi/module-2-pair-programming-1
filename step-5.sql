...
VALUES ('Ohiopyle', 'Pennsylvania', '1965-01-01', 19052, 1000000, 'Ohiopyle State Park is a Pennsylvania state park on 19,052 acres in Dunbar, Henry Clay and Stewart Townships, Fayette County, Pennsylvania in the United States. The focal point of the park is the more than 14 miles of the Youghiogheny River Gorge that passes through the park.');
...
INSERT INTO reservation (site_id, name, from_date, to_date)
VALUES (624, 'Parker Family', NOW() + INTERVAL '11 days', NOW() + INTERVAL '20 days');
INSERT INTO reservation (site_id, name, from_date, to_date)
VALUES (625, 'Kent Family', NOW() + INTERVAL '12 days', NOW() + INTERVAL '20 days');
